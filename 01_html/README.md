...
Siehe auch die Datei `html-example.html` hier:
...
Versucht mal unten abgebildetes Gästebuch nachzubauen.

Bonusaufgabe: Findet heraus, wie ihr das :smile: Icon in der URL neben dem Wilkommen einfügen könnt.

![](pictures/example-website.jpg)